 ...
 * <p>
 * To use the component, simply add it to your view hierarchy. Then in your {@link android.app.Activity} or {@link android.support.v4.app.Fragment} call {@link #setViewPager(ViewPager)} providing it
 * the ViewPager this layout is being used for.
 * <p>
 * The colors can be customized in two ways. The first and simplest is to provide an array of colors via {@link #setSelectedIndicatorColors(int...)}. The alternative is via the {@link TabColorizer}
...
public class SlidingTabLayout extends HorizontalScrollView {
	 ...
	 * If you only require simple customization then you can use {@link #setSelectedIndicatorColors(int...)} to achieve
	 * similar effects.
	 */
