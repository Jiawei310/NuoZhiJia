...
- (instancetype)initWith:(NSInteger)yearIndex Month:(NSInteger)monthIndex Day:(NSInteger)dayIndex
{
    ...
    if (self) {
        ...
        self.frame = CGRectMake(0, mScreenHeight, mScreenWidth, 244);
        [window addSubview:self.bgView];
        [window addSubview:self];
        
        self.backgroundColor = [UIColor whiteColor];
        
        UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(315*Ratio_NAV_W, 11*Ratio_NAV_H, 45*Ratio_NAV_W, 16*Ratio_NAV_H)];
        ...
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 40*Ratio_NAV_H, 375*Ratio_NAV_W, 0.5*Ratio_NAV_H)];
        ...
        self.datePickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 44*Ratio_NAV_H, 375*Ratio_NAV_W, 200*Ratio_NAV_H)];
        self.datePickerView.tag = 1;
        self.datePickerView.delegate = self;
        self.datePickerView.dataSource = self;
        [self addSubview:_datePickerView];
        
        UILabel *yearLabel = [[UILabel alloc] initWithFrame:CGRectMake(120*Ratio_NAV_W, 126*Ratio_NAV_H, 20*Ratio_NAV_W, 36*Ratio_NAV_H)];
        yearLabel.textColor = [UIColor colorWithRed:0x6A/255.0 green:0x6C/255.0 blue:0x6C/255.0 alpha:0.8];
        yearLabel.font = [UIFont systemFontOfSize:22];
        yearLabel.text = @"年";
        [self addSubview:yearLabel];
        
        UILabel *monthLabel = [[UILabel alloc] initWithFrame:CGRectMake(210*Ratio_NAV_W, 126*Ratio_NAV_H, 20*Ratio_NAV_W, 36*Ratio_NAV_H)];
        monthLabel.textColor = [UIColor colorWithRed:0x6A/255.0 green:0x6C/255.0 blue:0x6C/255.0 alpha:0.8];
        monthLabel.font = [UIFont systemFontOfSize:22];
        monthLabel.text = @"月";
        [self addSubview:monthLabel];
        
        UILabel *dayLabel = [[UILabel alloc] initWithFrame:CGRectMake(315*Ratio_NAV_W, 126*Ratio_NAV_H, 20*Ratio_NAV_W, 36*Ratio_NAV_H)];
        dayLabel.textColor = [UIColor colorWithRed:0x6A/255.0 green:0x6C/255.0 blue:0x6C/255.0 alpha:0.8];
...
- (instancetype)initWithFrame:(CGRect)frame Year:(NSInteger)yearIndex Month:(NSInteger)monthIndex
{
    ...
    if (self)
    {
        // 初始化设置
        UIWindow *window = [UIApplication sharedApplication].keyWindow;
        self.frame = CGRectMake(0, mScreenHeight, mScreenWidth, 248*Ratio_NAV_H);
        [window addSubview:self.bgView];
        [window addSubview:self];
        ...
        UILabel *yearLabel = [[UILabel alloc] initWithFrame:CGRectMake(170*Ratio_NAV_W, 126*Ratio_NAV_H, 20*Ratio_NAV_W, 36*Ratio_NAV_H)];
        yearLabel.textColor = [UIColor colorWithRed:0x6A/255.0 green:0x6C/255.0 blue:0x6C/255.0 alpha:0.8];
        yearLabel.font = [UIFont systemFontOfSize:22];
        yearLabel.text = @"年";
        [self addSubview:yearLabel];
        
        UILabel *monthLabel = [[UILabel alloc] initWithFrame:CGRectMake(262*Ratio_NAV_W, 126*Ratio_NAV_H, 20*Ratio_NAV_W, 36*Ratio_NAV_H)];
        monthLabel.textColor = [UIColor colorWithRed:0x6A/255.0 green:0x6C/255.0 blue:0x6C/255.0 alpha:0.8];
        monthLabel.font = [UIFont systemFontOfSize:22];
        monthLabel.text = @"月";
        [self addSubview:monthLabel];
...
- (void)confirmBtnClick:(UIButton *)sender
{
    if (self.datePickerView.tag == 0)
    {
        ...
        NSString *birthday=[NSString stringWithFormat:@"%@年%@月",[self.yearArray objectAtIndex:self.yearIndex],birthMonth];
    ...
    else
    {
        ...
        NSString *birthday=[NSString stringWithFormat:@"%@年%@月%@日",[self.yearArray objectAtIndex:self.yearIndex],birthMonth,birthDay];
        self.gotoSrceenOrderBlock(birthday);
    }
}
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    if (pickerView.tag == 0)
    {
        if(component == 0)
        {
            label = [[UILabel alloc] initWithFrame:CGRectMake(400*Ratio_W, 0, 60*Ratio_W, 36*Ratio)];
            label.textAlignment = NSTextAlignmentRight;
            label.text = self.yearArray[row];
            label.font = [UIFont fontWithName:@"DINPro-Regular" size:24];
        ...
        {
            label = [[UILabel alloc] initWithFrame:CGRectMake(10*Ratio_W, 0, 35*Ratio_W, 36*Ratio)];
            label.textAlignment = NSTextAlignmentRight;
            label.font = [UIFont fontWithName:@"DINPro-Regular" size:24];
