...
- (void)viewDidLoad {
    ...
    relatedAnswerTableView=[[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, SCREENHEIGHT) style:UITableViewStylePlain];
    //自动计算cell高度
    relatedAnswerTableView.estimatedRowHeight = 100.0f;
    relatedAnswerTableView.rowHeight = UITableViewAutomaticDimension;
