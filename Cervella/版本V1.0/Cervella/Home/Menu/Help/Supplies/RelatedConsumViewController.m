...
- (void)viewDidLoad {
    ...
    self.title = @"Related consumables";
    ...
    relatedTableView=[[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, SCREENHEIGHT) style:UITableViewStylePlain];
    //自动计算cell高度
    relatedTableView.estimatedRowHeight = 100.0f;
    relatedTableView.rowHeight = UITableViewAutomaticDimension;
