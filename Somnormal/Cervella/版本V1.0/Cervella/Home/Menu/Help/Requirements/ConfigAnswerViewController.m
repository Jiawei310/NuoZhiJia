...
- (void)viewDidLoad {
    ...
    configAnswerTableView=[[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, SCREENHEIGHT) style:UITableViewStylePlain];
    //自动计算cell高度
    configAnswerTableView.estimatedRowHeight = 100.0f;
    configAnswerTableView.rowHeight = UITableViewAutomaticDimension;
