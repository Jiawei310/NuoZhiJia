...
- (void)viewDidLoad {
    ...
    clinicalAnswerTableView=[[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, SCREENHEIGHT) style:UITableViewStylePlain];
    //自动计算cell高度
    clinicalAnswerTableView.estimatedRowHeight = 100.0f;
    clinicalAnswerTableView.rowHeight = UITableViewAutomaticDimension;
