...
- (void)viewDidLoad {
    ...
    _Label_One.text = @"Unbind after, Somnormal will not work properly";
    _Label_One.adjustsFontSizeToFitWidth = YES;
    _Label_Two.textAlignment = NSTextAlignmentCenter;
    _Label_Two.text=@"Unbind after, Somnormal can be connected using other mobile phone or replace it";
    ...
    [_FreeBindButton setTitle:@"Unbind Somnormal" forState:UIControlStateNormal];
    if (SCREENHEIGHT == 667)
    {
