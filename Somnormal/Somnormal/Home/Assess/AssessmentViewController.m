...
-(void)addResult:(NSMutableArray *)resultArray
{
    ...
    if (_tableListTag==1)
    {
        ...
        {
            myStrOne=@"normal";
            myStrTwo=@"Sleep quality is normal.Suggest you to use Somnormal for treatment.";
        }
        else if (Mark>=11 && Mark<=15)
        {
            myStrOne=@"poor";
            myStrTwo=@"Sleep quality is poor.Suggest you to use Somnormal for treatment.";
        }
        else if (Mark>=16 && Mark<=21)
        {
            myStrOne=@"very poor";
            myStrTwo=@"Sleep quality is very poor.Suggest you to use Somnormal for treatment.";
        }
